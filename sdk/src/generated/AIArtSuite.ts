 ...
 * @returns True if the condition is met, false otherwise
 */
export async function ValidArt(art: number, searchAllLayerLists: boolean): Promise<boolean> {
    const result = await callCpp<{ result: boolean }>(SUITE_NAME, 'ValidArt', { art, searchAllLayerLists });
 ...
 * @returns True if the condition is met, false otherwise
 */
export async function ArtHasFill(art: number): Promise<boolean> {
    const result = await callCpp<{ result: boolean }>(SUITE_NAME, 'ArtHasFill', { art });
    return result.result;
}
 ...
 * @returns True if the condition is met, false otherwise
 */
export async function ArtHasStroke(art: number): Promise<boolean> {
    const result = await callCpp<{ result: boolean }>(SUITE_NAME, 'ArtHasStroke', { art });
    return result.result;
}
 ...
 * @returns True if the condition is met, false otherwise
 */
export async function HasDictionary(art: number): Promise<boolean> {
    const result = await callCpp<{ result: boolean }>(SUITE_NAME, 'HasDictionary', { art });
    return result.result;
}
 ...
 * @returns True if the condition is met, false otherwise
 */
export async function IsDictionaryEmpty(art: number): Promise<boolean> {
    const result = await callCpp<{ result: boolean }>(SUITE_NAME, 'IsDictionaryEmpty', { art });
    return result.result;
}
 ...
 * @param art - Handle to the art object
 * @returns An object containing: name, isDefaultName
 */
export async function GetArtName(art: number): Promise<{ name: string; isDefaultName: boolean }> {
    const result = await callCpp<{ name: string; isDefaultName: boolean }>(SUITE_NAME, 'GetArtName', { art });
    return result;
}
 ...
 * @returns True if the condition is met, false otherwise
 */
export async function IsArtLayerGroup(art: number): Promise<boolean> {
    const result = await callCpp<{ isLayerGroup: boolean }>(SUITE_NAME, 'IsArtLayerGroup', { art });
 ...
 */
export async function ReleaseToLayers(art: number, build: boolean): Promise<void> {
 ...
 * @returns True if the condition is met, false otherwise
 */
export async function IsArtStyledArt(art: number): Promise<boolean> {
    const result = await callCpp<{ result: boolean }>(SUITE_NAME, 'IsArtStyledArt', { art });
    return result.result;
}
 ...
 * @returns True if the condition is met, false otherwise
 */
export async function IsArtClipping(art: number): Promise<boolean> {
    const result = await callCpp<{ result: boolean }>(SUITE_NAME, 'IsArtClipping', { art });
    return result.result;
}
 ...
 */
export async function TransferAttributes(srcart: number, dstart: number, which: number): Promise<void> {
 ...
 * @param art - Handle to the art object
 * @returns The out note value
 */
export async function GetNote(art: number): Promise<string> {
    const result = await callCpp<{ outNote: string }>(SUITE_NAME, 'GetNote', { art });
    return result.outNote;
}
 ...
 * @returns True if the condition is met, false otherwise
 */
export async function HasNote(art: number): Promise<boolean> {
    const result = await callCpp<{ result: boolean }>(SUITE_NAME, 'HasNote', { art });
    return result.result;
}
 ...
 */
export async function SetArtXMP(art: number, xmp: string): Promise<void> {
 ...
 * @returns True if the condition is met, false otherwise
 */
export async function IsPixelPerfect(art: number): Promise<boolean> {
    const result = await callCpp<{ result: boolean }>(SUITE_NAME, 'IsPixelPerfect', { art });
    return result.result;
}
 ...
 */
export async function GetArtDefaultName(art: number): Promise<string> {
    const result = await callCpp<{ name: string }>(SUITE_NAME, 'GetArtDefaultName', { art });
    return result.name;
}
