...
/** GET /api/query/find - Find art objects by name. Iterates document art tree using AIArtSuite::GetArtFirstChild/GetArtSibling, checking GetArtName against the query string. */
...
export async function FindArtByName(params: FindArtByNameRequest): Promise<FindArtByNameResponse> {
  return fetchRoute<FindArtByNameResponse>('GET', getApiUrl('/api/query/find'), JSON.stringify(params));
}
