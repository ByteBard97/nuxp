...
#define kAIGradientSuiteVersion10	AIAPI_VERSION(10)
/** Gradient suite version */
#define kAIGradientSuiteVersion		kAIGradientSuiteVersion10
/** Gradient suite version */
...
namespace ai 
{
	/** Types of gradient interpolation methods. */
	enum class GradientInterpolationType : ai::uint8
	{
		/** Classic gradient interpolation method. */
		kClassicGradientInterpolation = 0,
		/** Perceptual gradient interpolation method. */
		kPerceptualGradientInterpolation = 1
	};
}
...
typedef struct {
	...
	*/
	...
	/* New in Illustrator 30.0 - Version 10 */

	/** Retrieves the Dithering property of a gradient.
			@param gradient The gradient object.
			@param isDither [out] A buffer in which to return the dither property.
		*/
	AIAPI AIErr (*GetGradientDitherProperty) ( AIGradientHandle gradient, AIBoolean &isDither );

	/** Sets the Dithering property of a gradient.
			@param gradient The gradient object.
			@param isDither When true, enables dithering for the gradient.
		*/
	AIAPI AIErr (*SetGradientDitherProperty) ( AIGradientHandle gradient, AIBoolean isDither );

	/** Retrieves the interpolation type of a gradient, classic or perceptual.
			 @param gradient The gradient object.
			 @param interpolationType [out] A buffer in which to return the interpolation type constant, either
			 	\c #kClassicGradientInterpolation or \c #kPerceptualGradientInterpolation.
		*/
	AIAPI AIErr (*GetGradientInterpolationType) ( AIGradientHandle gradient, ai::GradientInterpolationType &interpolationType );

	/** Sets the interpolation type of a gradient, classic or perceptual.
			 @param gradient The gradient object.
			 @param interpolationType The interpolation type constant, \c #kClassicGradientInterpolation or \c #kPerceptualGradientInterpolation.
		*/
	AIAPI AIErr (*SetGradientInterpolationType) ( AIGradientHandle gradient, ai::GradientInterpolationType interpolationType );
} AIGradientSuite;
